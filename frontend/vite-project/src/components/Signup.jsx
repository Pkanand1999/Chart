...
export default function Signup({changetologin}) {
  return (
    <>
    <div className=" w-2/5">
    <div>
  ...
  ,height:"26px",textAlign:"center",padding:"1px 5px",margin:"0"}} className="font-light"/></div>
    </div>
    ...
    <form className="p-5 flex-column font-medium w-full ">
      ...
      <input type="text" placeholder="Enter your name"  className="border-none bg-gray-200 p-1 rounded-xl mb-3 w-full " autoComplete="off"/>
      ...
      <button className="bg-black text-white p-1.5 w-full rounded-xl font-bold cursor-pointer" >Sign Up</button>
    </form>
    </div>
